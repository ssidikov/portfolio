...
export default function Header() {
  ...
  return (
    <header className='fixed top-0 left-0 right-0 z-50 bg-[hsl(var(--background)/0.0)] backdrop-blur-xl md:backdrop-blur-md border-b border-[hsl(var(--border))]'>
      <div className='container mx-auto px-4 py-2 flex items-center justify-between'>        {/* Logo */}
        <a 
          href='/' 
        ...
        <div className='flex items-center md:hidden'>
          ...
          <button
            ...
            aria-label='Toggle menu'>            <motion.svg
              className='w-6 h-6'
              fill='none'
              stroke='currentColor'
              strokeWidth='2'
      ...
      {/* Mobile menu */}      <AnimatePresence mode="wait">
        {menuOpen && (
          <motion.div
            ...
            <motion.nav
              ...
              initial='hidden'
              animate='visible'
              exit='hidden'>              <motion.div variants={itemVariants}>
                <a
                  href='/#home'
